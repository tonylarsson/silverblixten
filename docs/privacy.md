...
This application is designed with your privacy in mind. The app does not collect, transmit, or share any personal data. Everything you do in the app stays on your device.

## Data Storage

All data is stored locally on your device using Apple's built-in data framework. Your data is never uploaded to any server.
...
Since all data is stored locally on your device, you can delete it at any time by uninstalling the app.
